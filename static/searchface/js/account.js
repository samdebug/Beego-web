        ...
        setPopupParams: function () {
          var html = '<div class="change-password-li">' +
            '<div class="change-password-div"><div class="change-password-label">' +
              '<span class="change-password-span">原密码</span>' +
        ...
        setPassword: function () {
          $(".change-password").off().one("click", function () {
            ...
            $(".popup-confirm-div").off().on("click", function(){
              ...
              var pass1 = $(".change-password-input").eq(1).val();
              var pass2 = $(".change-password-input").eq(2).val();
              ...
              if (pass1 !== "" && pass2 !== "" && pass1 !== undefined && pass2 !== undefined) {
                if (pass1 === pass2) {
                  ...
                  $.ajax({
                    type: 'post',
                    url: urls.setPassword(id, pass0, pass1),
                    dataType: 'text',
                    jsonp: "jsoncallback",
                    async: false,
                    success: function (data) {
                      ...
                      if (result.result == "success") {
                        alert("修改成功！");
                        popup.close();
                      } else if (result.errorMessage == "old password error") {
                        alert("原密码不匹配");
                        return false;
