...
func init() {
	...
	beego.Router("/manager/librarys", &controllers.LibController{}, "*:Librarys")
	beego.Router("/manager/librarys/create", &controllers.LibController{}, "post:AddLibrary")
	beego.Router("/manager/librarys/delete", &controllers.LibController{}, "post:DelLibrary")
	beego.Router("/manager/librarys/:id", &controllers.LibController{}, "*:UpdateLibrary")

	beego.Router("/manager/librarys/:lib/targets", &controllers.TargetController{}, "get:Targets")
	beego.Router("/manager/librarys/:lib/targets/create ", &controllers.TargetController{}, "*:AddTarget")
	beego.Router("/manager/librarys/:lib/targets/delete ", &controllers.TargetController{}, "*:DelTarget")
	beego.Router("/manager/librarys/:lib/targets/:id", &controllers.TargetController{}, "*:UpdateTarget")

	beego.Router("/manager/videos", &controllers.VideosController{}, "*:Videos")
	beego.Router("/manager/videos/create", &controllers.VideosController{}, "post:AddVideo")
	beego.Router("/manager/videos/delete", &controllers.VideosController{}, "post:DelVideo")
	beego.Router("/manager/videos/:id", &controllers.VideosController{}, "*:UpdateVideo")
	...
	beego.Router("/uploads", &controllers.UploadController{}, "get:Uploading")
